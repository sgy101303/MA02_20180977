...
public class HospitalReviewDBHelper extends SQLiteOpenHelper {

    final static String DB_NAME = "reviewHospital.db";
    public final static String TABLE_NAME = "review_hospital_table";
    ...
    public HospitalReviewDBHelper(Context context) {
    ...
    public void onCreate(SQLiteDatabase db) {
        String sql = "CREATE TABLE " + TABLE_NAME + " (" + COL_ID + " integer primary key autoincrement, "
                ...
                + COL_DUTYMAPIMG + " TEXT, " + COL_WGS84LAT + " TEXT, " + COL_WGS84LON + " TEXT, " + COL_DATE + " TEXT, " + COL_REVIEW  + " TEXT, " + COL_IMG + " TEXT)";
