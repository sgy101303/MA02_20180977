...
public class HospitalAdapter extends BaseAdapter {
    static final String TAG = "HospitalAdapter";
...
//    private ImageFileManager imageFileManager = null;
    ...
    public HospitalAdapter(Context context, int resource, ArrayList<HospitalDTO> list) {
...
//        networkManager = new NaverNetworkManager(context);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            viewHolder.dutyName = view.findViewById(R.id.hName);
            viewHolder.dutyAddr = view.findViewById(R.id.tvAddr);
//            viewHolder.btnCall = view.findViewById(R.id.btnCallItem);

//            viewHolder.btnCall.setOnClickListener(btnCallListener);
        ...
        viewHolder.dutyName.setText(dto.getDutyName());
        viewHolder.dutyAddr.setText(dto.getDutyAddr());
//        viewHolder.btnCall.setTag(Integer.valueOf(position));
...
//            viewHolder.hImg.setImageResource(R.mipmap.ic_launcher);
//            return view;
//        }
        // 파일에 있는지 확인
...
//
//        if(savedBitmap != null) {
//            viewHolder.hImg.setImageBitmap(savedBitmap);
...
//    final View.OnClickListener btnCallListener = new View.OnClickListener() {
//        @Override
//        public void onClick(View v) {
//            int position = (Integer)v.getTag();
//            HospitalDTO dto = list.get(position);
//            Toast.makeText(parentContext, dto.getDutyTel1(), Toast.LENGTH_SHORT).show();
//            Intent intent = new Intent(Intent.ACTION_DIAL, Uri.parse(dto.getDutyTel1()));
//            parentContext.startActivity(intent);
//        }
//    };

    public void setList(ArrayList<HospitalDTO> list) {
        this.list = list;
    ...
    static class ViewHolder {
        public TextView dutyName = null;
        public TextView dutyAddr = null;
...
//            if(bitmap != null) {
//                viewHolder.hImg.setImageBitmap(bitmap);
